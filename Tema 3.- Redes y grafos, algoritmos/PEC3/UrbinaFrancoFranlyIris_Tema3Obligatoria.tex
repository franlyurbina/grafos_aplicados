...
\textit{term}, \textit{prison} y \textit{permit} ocupan posiciones destacadas en ambas 
...
alta de coaparición, lo que sugiere que forman parte del vocabulario central de esta comunidad.
...
El núcleo principal es estable, ya que seis de los diez términos coinciden en ambas tablas, 
lo que refleja coherencia temática entre los nodos más conectados y los más intensamente 
relacionados. Esta coincidencia indica que los conceptos dominantes mantienen su relevancia 
independientemente de si se mide la amplitud estructural o la fuerza acumulada de sus vínculos.

Destaca \textit{bond}, que no aparece entre los nodos con 
...
contexto de la comunidad. De forma similar, \textit{courtroom} y \textit{vindication} aparecen 
solo en el listado ponderado, lo que sugiere que representan conceptos específicos con relaciones 
fuertes pero concentradas.
...
términos más generales. La distribución de los nodos sugiere que esta comunidad se organiza en torno a un 
campo semántico relacionado con el ámbito legal o judicial, donde conceptos como 
\textit{prison}, \textit{permit}, \textit{violate}, \textit{approve} o \textit{courtroom} 
apuntan a procesos normativos, decisiones formales y situaciones de carácter jurídico. Por este 
...
legal y punitiva que se le puede atribuir a la temática donimante.



\section*{Comunidad 2 - Investigate}

En la Comunidad 2 se observa una estructura distribuida donde los términos 
\textit{sewer}, \textit{brief}, \textit{adjustment} e \textit{investigate} destacan en ambas 
métricas, lo que indica que constituyen el núcleo estructural y semántico del subgrafo. 
Estos nodos combinan un número elevado de conexiones distintas con una intensidad alta de 
coaparición, lo que los sitúa como puntos centrales dentro de la red.
...
La coincidencia es parcial entre ambas tablas, ya que cuatro de los 
diez términos aparecen en los dos rankings, lo que sugiere que la comunidad posee un centro 
conceptual estable, pero también una generalización con algunos nodos cambian de relevancia 
según se mida la diversidad de conexiones o la intensidad de las relaciones.

Términos como \textit{file}, \textit{gun}, 
\textit{sheriff}, \textit{pension} u \textit{object} aparecen únicamente en el listado por grado, 
lo que indica que se relacionan con muchos términos distintos pero con menor frecuencia total, 
actuando como nodos de enlace o elementos contextuales amplios dentro de la comunidad.

Por el contrario, palabras como \textit{hire}, \textit{assure}, \textit{reject}, 
\textit{privilege}, \textit{employe} o \textit{provision} solo aparecen en el ranking ponderado, 
lo que sugiere que mantienen relaciones más intensas aunque con menos conexiones distintas, 
característica propia de términos especializados o dependientes de contextos más concretos.
El campo semántico parece estar vinculado a procesos 
administrativos, legales y organizativos, donde conceptos relacionados con investigación, 
documentación y procedimientos formales aparecen como elementos dominantes. Por este motivo, el 
término más representativo para esta comunidad es \textit{investigate}, ya que aparece entre los 
nodos con mayor grado y peso y sintetiza el eje temático que articula el resto de relaciones.
...
En la Comunidad 3 se observa una estructura jerárquica donde los términos 
\textit{police}, \textit{construction}, \textit{hearing}, \textit{attorney}, \textit{admit}, 
...
El núcleo principal presenta una coincidencia elevada entre ambas tablas con siete de los 
diez términos en común en ambos rankings. Esto indica que los conceptos centrales 
de la comunidad mantienen relevancia tanto en la amplitud de relaciones como en 
intensidad total de sus vínculos, lo que sugiere una cohesión temática fuerte y estable.

Entre las diferencias más relevantes se observa que términos como \textit{arrest}, 
\textit{investigation} y \textit{court} aparecen únicamente en el listado por grado, lo que indica 
que se relacionan con un número amplio de términos distintos pero con menor intensidad acumulada, 
actuando como nodos de enlace o elementos contextuales generales dentro de la comunidad. Mientras
tanto, palabras como \textit{jury}, \textit{fire} y \textit{receive} solo aparecen en el 
ranking ponderado, lo que indica que mantienen relaciones más intensas aunque con menos conexiones 
distintas, característica propia de términos más específicos o dependientes de contextos concretos.

El campo semántico se ve vinculado al ámbito judicial y 
administrativo, donde conceptos relacionados con procedimientos legales, autoridades y gestión 
institucional estructuran la comunidad. Por este motivo, el término más representativo para esta 
comunidad es \textit{police}, ya que aparece como el nodo con mayor grado y peso y sintetiza el eje 
temático dominante del subgrafo.
...
En la Comunidad 4 se observa una estructura jerárquica bien definida donde los términos 
\textit{consultation}, \textit{ally}, \textit{diplomatic} y \textit{prevent} ocupan posiciones 
destacadas en ambas métricas, lo que indica que constituyen el núcleo estructural y semántico 
del subgrafo. Estos nodos presentan simultáneamente una alta diversidad de conexiones y una 
intensidad elevada de coaparición, lo que evidencia su papel central dentro de la red.
...
Entre las variaciones más relevantes se observa que términos como \textit{intervention}, 
\textit{bloc}, \textit{neutralist}, \textit{bitter}, \textit{tension} y \textit{allied} aparecen 
únicamente en el ranking por grado. Esto indica que se relacionan con un número amplio de términos 
distintos, aunque con menor intensidad acumulada, lo que sugiere que funcionan como elementos de 
contexto general o nodos de enlace dentro de la estructura temática.

Por el contrario, palabras como \textit{reaction}, \textit{political}, \textit{climate}, 
\textit{global}, \textit{timely} o \textit{inclination} solo aparecen en el listado ponderado, lo 
...
Los nodos que ganan peso son 
los que realmente sostienen la intensidad temática orientada a la diplomacia 
y las relaciones internacionales, donde conceptos asociados a alianzas, prevención de 
conflictos y cooperación política estructuran la comunidad. Por este motivo, el 
término más representativo para esta comunidad es \textit{diplomatic}, ya que 
aparece entre los nodos con mayor 
grado y peso y sintetiza el eje temático dominante del subgrafo.

 

\section*{Comunidad 5 - Estimate}
En la Comunidad 5 se observa una estructura relativamente equilibrada donde los términos 
\textit{estimate}, \textit{residential}, \textit{outlay}, \textit{approval} y \textit{victim} 
aparecen en posiciones destacadas en ambas métricas, lo que indica que constituyen el núcleo 
estructural y semántico del subgrafo. Estos nodos presentan simultáneamente una diversidad notable 
de conexiones y una intensidad elevada de coaparición, situándose como puntos centrales dentro de 
la red.
...
Entre las diferencias más relevantes se observa que términos como \textit{flat}, \textit{chain}, 
\textit{builder}, \textit{atomic} y \textit{shopping} aparecen únicamente en el listado por grado, 
lo que indica que se relacionan con muchos términos distintos pero con menor frecuencia total, 
actuando como nodos de enlace o elementos contextuales amplios dentro del subgrafo.

Por el contrario, palabras como \textit{proposal}, \textit{increase}, \textit{personal}, 
\textit{payment} o \textit{requirement} solo aparecen en el ranking ponderado, lo que indica que 
...
El campo semántico está vinculado a procesos económicos y 
administrativos relacionados con planificación, inversión y gestión de recursos, donde conceptos 
asociados a estimaciones, gastos y aprobaciones destacan en la comunidad.El término 
más representativo es \textit{estimate}, ya que aparece como el nodo con mayor 
grado y peso y sintetiza el eje temático dominante del subgrafo, lo que confirma 
que sus relaciones no solo son numerosas, sino también las más intensas y 
frecuentes dentro de la comunidad.
...
aleatoria, sino que está anclada a conceptos técnicos de este clúster específico.
...
Entre las diferencias más relevantes se observa que términos como \textit{enterprise}, 
\textit{profession}, \textit{european}, \textit{circumstance}, \textit{application} y 
\textit{eliminate} aparecen únicamente en el listado por grado, lo que indica que se relacionan 
con muchos términos distintos pero con menor intensidad total, actuando como nodos de enlace o 
elementos contextuales amplios dentro de la comunidad.

Por el contrario, palabras como \textit{scheme}, \textit{protective}, \textit{brand}, 
\textit{paradox}, \textit{substitute} y \textit{artificial} solo aparecen en el ranking ponderado, 
lo que indica que mantienen relaciones más intensas aunque con menos conexiones distintas, rasgo 
propio de términos más específicos o dependientes de contextos concretos.

El campo semántico sugiere un ámbito conceptual relacionado con procesos, variación y funcionamiento 
de sistemas, donde aparecen términos asociados a mecanismos, cambios y condiciones de operación. Por 
...
\newpage
\section*{Comunidad 7 - Pilot}

En la Comunidad 7 se observa una estructura parcialmente concentrada donde los términos 
\textit{automatic}, \textit{taxi} y \textit{halt} que sugieren una comunidad heterogénea y 
dispersa, con conexiones variadas pero posiblemente accidentales o de baja frecuencia en el corpus. 
Esto podría reflejar una amplitud estructural alta pero con poca fuerza de enlace en la 
matriz de adyacencia.
Sin embargo, al aplicar la métrica de grado con pesos, la estructura cambia por completo. 
Aparece un bloque sólido de términos relacionados con la aeronáutica 
\textit{cockpit}, \textit{bomber}, \textit{runway}, 
\textit{jet}, que poseen exactamente el mismo peso de interacción. 
Este fenómeno indica la existencia de una ``clique'' o subgrupo con una relación más fuerte entre sí 
que con el resto de la red y solo aparecen en el ranking 
ponderado, lo que refuerza que mantienen relaciones más intensas aunque con menos conexiones 
distintas, rasgo característico de términos especializados o dependientes de contextos muy 
concretos.
El término halt, que ocupa una posición baja en grado simple, escala hasta la 
segunda posición ponderada, lo que demuestra que su uso está íntimamente ligado a 
este contexto específico de aviación.
...
Entre las diferencias más relevantes se observa que términos como \textit{farmer}, 
\textit{fuel}, \textit{disclose}, \textit{crime}, \textit{mortgage}, \textit{write} y 
\textit{wage} aparecen únicamente en el listado por grado, lo que indica que se relacionan con 
muchos términos distintos pero con menor intensidad total, actuando como nodos de enlace o 
elementos contextuales amplios dentro de la comunidad.
 
El campo semántico apunta a un ámbito relacionado con transporte y sistemas mecánicos, 
especialmente asociado al contexto de vehículos, funcionamiento técnico y maniobras. 
Por este motivo, el término más representativo 
es \textit{Pilot}, ya que aparece entre los nodos con mayor grado y peso y sintetiza el eje temático 
dominante del subgrafo.
